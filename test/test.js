...
global.elapsed['update_obj'] = {n:0,ms:0}
global.elapsed['update_arr'] = {n:0,ms:0}
global.elapsed['select'] = {n:0,ms:0}
global.elapsed['select_obj'] = {n:0,ms:0}
global.elapsed['select_arr'] = {n:0,ms:0}
global.elapsed['parse'] = {n:0,ms:0}
...
console.log('request mapping took ' + (performance.now() - timer) + 'ms')

console.log('ObjectMapper: ' + global.elapsed['ObjectMapper'].ms + " iterated " + global.elapsed['ObjectMapper'].n + " times.")
console.log('update:       ' + global.elapsed['update'].ms + " iterated " + global.elapsed['update'].n + " times.")
console.log('update_obj:   ' + global.elapsed['update_obj'].ms + " iterated " + global.elapsed['update_obj'].n + " times.")
console.log('update_arr:   ' + global.elapsed['update_arr'].ms + " iterated " + global.elapsed['update_arr'].n + " times.")
console.log('select:       ' + global.elapsed['select'].ms + " iterated " + global.elapsed['select'].n + " times.")
console.log('select_obj:   ' + global.elapsed['select_obj'].ms + " iterated " + global.elapsed['select_obj'].n + " times.")
console.log('select_arr:   ' + global.elapsed['select_arr'].ms + " iterated " + global.elapsed['select_arr'].n + " times.")
console.log('parse:        ' + global.elapsed['parse'].ms + " iterated " + global.elapsed['parse'].n + " times.")
console.log('process:      ' + global.elapsed['process'].ms + " iterated " + global.elapsed['process'].n + " times.")
console.log('getKeyValue:  ' + global.elapsed['getKeyValue'].ms + " iterated " + global.elapsed['getKeyValue'].n + " times.")
console.log('setKeyValue:  ' + global.elapsed['setKeyValue'].ms + " iterated " + global.elapsed['setKeyValue'].n + " times.")
